  ...
  return (
    <header className={styles.header}>
      <div className={styles.left}>
        ...
        <nav className={[styles.toggle, styles.sectionToggle].join(' ')} aria-label="Section">
          <NavLink
            to="/"
            end
            className={({ isActive }) =>
      ...
      <div className={styles.right}>
        <div className={[styles.toggle, styles.syncToggle].join(' ')} role="group" aria-label="Sync">
          <SupabaseSyncControl />
        </div>

        <div className={[styles.toggle, styles.themeToggle].join(' ')} role="group" aria-label="Theme">
          <button
            type="button"
